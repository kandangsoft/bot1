...
client.on('ready', () => {
    ...
    var guild2 = client.guilds.get('406354502023774208');
    if(guild2 && guild2.channels.get('592019399062454302')){
        guild2.channels.get('592019399062454302').send("ngilu euy...").then(() => client.destroy());
    }
});
